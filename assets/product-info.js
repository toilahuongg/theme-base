if (!customElements.get("product-info")) {
  customElements.define(
    ...
    class ProductInfo extends HTMLElement {
      ...
      async init() {
        this.onVariantChangeUnsubscriber = window.VelouraEvents.subscribe(
      ...
      handleUpdateProductInfo(productUrl) {
        return (html) => {
          ...
          this.updateButton(
            ...
            window.VelouraStrings.soldOut
          );
          this.currentVariant = variant;

          window.VelouraEvents.emit(PUB_SUB_EVENTS.variantChange, {
      ...
      updateButton(disable = true, text) {
        ...
        if (disable) {
          ...
          addButtonText.textContent = window.VelouraStrings.addToCart;
        }
      }
      ...
      setUnavailable() {
        this.updateButton(true, window.VelouraStrings.unavailable);
      ...
      initQuantityHandlers() {
        ...
        if (!this.hasAttribute("data-original-section-id")) {
          this.cartUpdateUnsubscriber = VelouraEvents.subscribe(
      ...
      setQuantityBoundries() {
        VelouraEvents.emit(PUB_SUB_EVENTS.quantityBoundries, {
          data: {
      ...
      updateQuantityRules(sectionId, productId, parsedHTML) {
        ...
        VelouraEvents.emit(PUB_SUB_EVENTS.quantityRules, {
          data: {
            sectionId,
            productId,
            parsedHTML,
