    ...
    class MediaGallery extends HTMLElement {
      ...
      initImageZoom() {
        ...
        const options = {
          ...
          pswpModule: window.VelouraTheme.PhotoSwipe,
          bgOpacity: 1,
          arrowPrev: false,
          arrowNext: false,
          zoom: false,
        ...
        this.lightbox = new window.VelouraTheme.PhotoSwipeLightbox(options);
      ...
      setActiveMedia(mediaId) {
        ...
        if (this.mediaLayout === "carousel" || VelouraSettings.isMobile) {
          this.mediaGallery &&
      ...
      scrollIntoView(selectedMedia) {
        if (VelouraSettings.isMobile) return;
