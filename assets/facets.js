class FacetFiltersForm extends HTMLElement {
  ...
  static renderElements(html, el, selector) {
    ...
    FacetFiltersForm.loading = new window.VelouraTheme.AnimateLoading(
      document.body,
  ...
  createSearchParams(form) {
    ...
    if (form.id === "FacetFiltersForm" && !VelouraSettings.isMobile) {
...
FacetFiltersForm.loading = new window.VelouraTheme.AnimateLoading(document.body, {
