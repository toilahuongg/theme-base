...
- Theme check: 330 files, 138 offenses (2 errors, 136 warnings) — **2 errors are pre-existing upstream code issues, not from this work** (see Blockers).
